...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btDocumentation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String url = "https://blackboxembedded.github.io/WunderLINQ-Documentation/en/index-insta360-android.html";
                Intent i = new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse(url));
                startActivity(i);
            }
        ...
        btSendLogs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(outputFile.exists()) {
                    ...
                    uris.add(FileProvider.getUriForFile(AboutActivity.this, "com.blackboxembedded.wunderlinqinsta360.fileprovider", outputFile));
