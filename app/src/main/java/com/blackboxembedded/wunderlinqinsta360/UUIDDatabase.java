...
public class UUIDDatabase {
    ...
    /**
     * Insta360 related UUID
     */
    public static final UUID UUID_INSTA360_CONTROL_SERVICE = UUID
            .fromString(GattAttributes.INSTA360_CONTROL_SERVICE);
    public static final UUID UUID_INSTA360_COMMAND_CHARACTERISTIC = UUID
            .fromString(GattAttributes.INSTA360_COMMAND_CHARACTERISTIC);
    public final static UUID UUID_INSTA360_COMMANDRESPONSE_CHARACTERISTIC = UUID
            .fromString(GattAttributes.INSTA360_COMMANDRESPONSE_CHARACTERISTIC);
    /**
     * Descriptor UUID
     */
