...
public class GattAttributes {
    ...
    /**
     * Insta360 Service and Characteristics
     */
    public static final String INSTA360_CONTROL_SERVICE = "0000be80-0000-1000-8000-00805f9b34fb";
    public static final String INSTA360_COMMAND_CHARACTERISTIC = "0000be81-0000-1000-8000-00805f9b34fb";
    public static final String INSTA360_COMMANDRESPONSE_CHARACTERISTIC = "0000be82-0000-1000-8000-00805f9b34fb";
    ...
    static {
        // Insta360
        attributesUUID.put(UUIDDatabase.UUID_INSTA360_CONTROL_SERVICE, "Insta360 Control Service");
        attributesUUID.put(UUIDDatabase.UUID_INSTA360_COMMAND_CHARACTERISTIC, "Insta360 Command Characteristic");
        attributesUUID.put(UUIDDatabase.UUID_INSTA360_COMMANDRESPONSE_CHARACTERISTIC, "Insta360 Command Response Characteristic");
